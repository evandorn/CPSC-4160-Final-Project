...
void Project4::update(float dt) {
    ...
    /*
  const float scale_dt = 2.0f;

  cocos2d::ScaleTo*
  flipLeft     = cocos2d::ScaleTo::create(scale_dt,1.0,1.0); //flips to left // need this
  cocos2d::ScaleTo* 
  flipRight    = cocos2d::ScaleTo::create(scale_dt,-1.0,1.0); //flips to right //need this

  cocos2d::FlipRight* //need this
  sequence = cocos2d::Sequence::create(flipRight, NULL); //need this

  cocos2d::FlipLeft* //need this
  sequence = cocos2d::Sequence::create(flipLeft, NULL); //need this

  //sprite->runAction(cocos2d::RepeatForever::create(sequence)); //need this
*/
